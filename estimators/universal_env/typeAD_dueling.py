...
if __name__ == "__main__":
    ...
    formated_train_path = "../../datasets/formated/formated_train_uni.data"
    formated_test_path = "../../datasets/formated/formated_test_uni.data"
    ...
    env = NetworkClassificationEnv(
            ...
            train_path=kdd_train,test_path=kdd_test,
...
#            json.dump(agent.model_network.model.to_json(), outfile)
    ...
    aggregated_data_test = np.argmax(labels,axis=1)
